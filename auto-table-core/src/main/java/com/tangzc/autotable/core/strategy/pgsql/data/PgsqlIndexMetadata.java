...
public class PgsqlIndexMetadata {
    ...
    public static PgsqlIndexMetadata create(Class<?> clazz, Field field, String indexPrefix) {
        // 获取当前字段的@Index注解
        ...
        if (null != index) {
            ...
            mysqlIndexMetadata.getColumns().add(IndexColumnParam.newInstance(realColumnName, null));
            return mysqlIndexMetadata;
        }
        return null;
    }

    public static PgsqlIndexMetadata create(Class<?> clazz, TableIndex tableIndex, String indexPrefix) {
