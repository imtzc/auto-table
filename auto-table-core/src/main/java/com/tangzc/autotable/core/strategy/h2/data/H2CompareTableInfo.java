...
public class H2CompareTableInfo extends CompareTableInfo {
     ...
     * 新增的列
     */
    private final List<ColumnMetadata> newColumnMetadataList = new ArrayList<>();
    /**
     * 修改的列
     */
    private final List<ColumnMetadata> modifyColumnMetadataList = new ArrayList<>();
    /**
     * 删除的索引
     */
    ...
    public String validateFailedMessage() {
        ...
        //     String addColumn = modifyColumnMetadataList.stream()
        ...
        //     }
        //     String modifyColumn = modifyColumnMetadataList.stream()
    ...
    //     this.modifyColumnMetadataList.add(new MysqlModifyColumnMetadata(ModifyType.ADD, mysqlColumnMetadata));
    // }
    //
    // public void addEditColumnMetadata(MysqlColumnMetadata mysqlColumnMetadata) {
    //     this.modifyColumnMetadataList.add(new MysqlModifyColumnMetadata(ModifyType.MODIFY, mysqlColumnMetadata));
    // }

    /**
     * 重设主键
     */
    public void resetPrimary(List<ColumnMetadata> primaries) {
